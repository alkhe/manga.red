...
exports['default'] = _React2['default'].createClass({
	...
	mixins: [_Link$State.State, _Symbiosis2['default'](_Actions$Stores.Stores.MangaTitle)],
	componentWillMount: function componentWillMount() {
		_Actions$Stores.Actions.MangaUI.toTitle();
	},
		...
		if (this.state.process == _Process2['default'].Done) {
			var chapters = this.state.manga.chapters.map(function (c) {
				return _React2['default'].createElement(
					_Link$State.Link,
					{ to: 'chapter', params: { alias: _this.getParams().alias, chapter: c[0] }, key: c[0], className: 'collection-item' },
					c[2]
				);
			});
